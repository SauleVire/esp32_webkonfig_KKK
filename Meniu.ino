        ...
        while(veiksmas!=4)                   // ta petla trwa tak dlugo az wcisniesz klawisz OK  
         {
           ...
           if(klaviaturos_pasikeitimas!=veiksmas)                    // ruszamy do pracy tylko wtedy gdy klaviaturos_pasikeitimasienil sie stan klawiatury
             {
             if (veiksmas==1) {KeiciamaReiksme++; if(KeiciamaReiksme>MaxReiksme) KeiciamaReiksme=MaxReiksme; 
             //lcd.setCursor(16,2);
             //lcd.print(KeiciamaReiksme); 
             delay(200);}
             if(veiksmas==2)  {KeiciamaReiksme--; if(KeiciamaReiksme<MinReiksme) KeiciamaReiksme=MinReiksme; 
             //lcd.setCursor(16,2);
             //lcd.print(KeiciamaReiksme); 
             delay(200);}
             if(veiksmas==4) // jesli wcisnieto OK 
               {
//                 lcd.setCursor(0,2); lcd.print(tekstas2); 

...
//  Setup DS18b20 temperature sensor
  ...
  pinMode(SKSiurblys,OUTPUT); // Saulės kolektoriaus siurblys, Relė 1 (iš kairės) IO33
  pinMode(AtSiurblys,OUTPUT); // išvadas ak. talpos siurblio junginėjimui, Relė 2 (iš kairės) IO32
  pinMode(BoTermostatas,OUTPUT); // išvadas boilerio termostatui, Relė 3 (iš kairės) IO13
  pinMode(BoSiurblys,OUTPUT); // išvadas boilerio siurbliui, Relė 4 (iš kairės) IO12
  pinMode(PVsiurblys,OUTPUT); // išvadas pamaišymo vožtuvo siurbliui, Relė 5 (iš kairės) IO21
  pinMode(PVuzdarymas,OUTPUT); // PV uždarymas Relė 6 (iš kairės) IO19
  pinMode(PVatidarymas,OUTPUT); // PV atidarymas Relė 7 (iš kairės) IO18
  pinMode(Laisva,OUTPUT); // Laisva Relė 8 (iš kairės) IO5
...
if (config.k_intervalas < 5) config.k_intervalas = 5;
...
if (config.intervalasEmon < 10) config.intervalasEmon = 10;
...
//  lcd.setTextColor(TFT_YELLOW);
//  lcd.setCursor(1, 1);
//  lcd.println(F("SauleVire.lt"));
yield();lcd.setCursor(1, 25); lcd.print(F("IP- "));lcd.setCursor(37, 25); lcd.print(WiFi.localIP());
...
//yield();lcd.setCursor(1, 50); lcd.print(DateTime.second);
lcd.fillRect(1,50,60,18,TFT_BLACK);
yield();lcd.drawNumber(DateTime.minute, 1, 50);lcd.print(F(" : "));lcd.drawNumber(DateTime.second, 33, 50);
